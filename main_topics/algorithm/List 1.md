...
- **알고리즘의 성능은 무엇으로 측정하는가?**
  ...
  - 시간 복잡도 ≒ **빅-오(O) 표기법**
    ...
    - 예를 들어
      ...
      ![image-20220209022506078](List 1.assets/image-20220209022506078.png)
...
- **다양한 시간 복잡도의 비교**
  ...
  ![image-20220209022736291](List 1.assets/image-20220209022736291.png)
  ...
  ![image-20220209022839235](List 1.assets/image-20220209022839235.png)
...
- **배열이란?**
  ...
  ![image-20220209022944823](List 1.assets/image-20220209022944823.png)
...
- **1차원 배열**
  ...
  - 1차원 배열의 선언
    ...
    - 이름 : 프로그램에서 사용할 배열의 이름
      ...
      ![image-20220209023150964](List 1.assets/image-20220209023150964.png)
...
- 배열 활용 예제 : Gravity
  ...
  - 그림 설명
    ...
    - 회전 결과, B상자의 낙차는 6, C상자의 낙차는 1이다.
      ...
      ![image-20220209092843477](List 1.assets/image-20220209092843477.png)
...
- **버블 정렬 과정 예시**
  ...
  ![image-20220209024144586](List 1.assets/image-20220209024144586.png)

  -두 번째 패스

  ![image-20220209024204407](List 1.assets/image-20220209024204407.png)
  ...
  ![image-20220209024221192](List 1.assets/image-20220209024221192.png)
  
  -네 번째 패스
  
  ![image-20220209024236364](List 1.assets/image-20220209024236364.png)
  
  -정렬 끝
  
  ![image-20220209024256244](List 1.assets/image-20220209024256244.png)
...
- **배열을 활용한 버블 정렬**
  ...
  ![image-20220209024331185](List 1.assets/image-20220209024331185.png)

​				![image-20220209102201549](List 1.assets/image-20220209102201549.png)	
...
- **[0, 4, 1, 3, 1, 2, 4, 1]을 카운팅 정렬하는 과정**
  ...
  ![image-20220209103240690](List 1.assets/image-20220209103240690.png)
  ...
  ![image-20220209104507645](List 1.assets/image-20220209104507645.png)
  ...
  ![image-20220209104559404](List 1.assets/image-20220209104559404.png)

  counts[4]를 감소시키고 temp에 4를 삽입한다.

  ![image-20220209110424872](List 1.assets/image-20220209110424872.png)
  ...
  ![image-20220209110808702](List 1.assets/image-20220209110808702.png)

  counts[1]을 감소시키고 temp에 1을 삽입한다.

  

  ![image-20220209111021659](List 1.assets/image-20220209111021659.png)

  counts[3]을 감소시키고  temp에 3을 삽입한다.

  ![image-20220209112106163](List 1.assets/image-20220209112106163.png)

  counts[1]을 감소시키고 temp에 1을 삽입한다.

  ![image-20220209112129657](List 1.assets/image-20220209112129657.png)

  counts[4]를 감소시키고 temp에 4를 삽입한다.

  ![image-20220209112158580](List 1.assets/image-20220209112158580.png)

  counts[0]를 감소시키고 temp에 0을 삽입한다.

  ![image-20220209112228933](List 1.assets/image-20220209112228933.png)
...
![image-20220209111057170](List 1.assets/image-20220209111057170.png)			
...
![image-20220209111824510](List 1.assets/image-20220209111824510.png)
...
- **완전 검색을 활용한 Baby-gin 접근**
  ...
  - 고려할 수 있는 모든 경우의 수 생성하기
    ...
    - 예) 입력으로 [2, 3, 5, 7, 7, 7]을 받았을 경우, 아래와 같이 순열을 생성할 수 있다.
      ...
      ![image-20220209112942459](List 1.assets/image-20220209112942459.png)

  - 해답 테스트하기

    - 앞의 3자리와 뒤의 3자리를 잘라, run과 triplet 여부를 테스트하고 최종적으로 baby-gin을 판단한다.

    - 예) ![image-20220209113033249](List 1.assets/image-20220209113033249.png)
...
- 예) {1. 2. 3}을 포함하는 모든 순열을 생성하는 함수
  ...
  ![image-20220209123602909](List 1.assets/image-20220209123602909.png)
...
- **탐욕 알고리즘 풀이**
  ...
  ​	counts 배열의 각 원소를 체크하여 run과 tiplet 및 baby-gin 여부를 판단한다.<img src="List 1.assets/image-20220209141418159.png" alt="image-20220209141418159" style="zoom:150%;" />

  ![image-20220209141430782](List 1.assets/image-20220209141430782.png)

  - 구현 예		![image-20220209141511356](List 1.assets/image-20220209141511356.png)![image-20220209141524919](List 1.assets/image-20220209141524919.png)
